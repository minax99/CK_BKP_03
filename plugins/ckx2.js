...
cmd({
    ...
    try {
        ...
        let res = await fetchJson(`https://apis-keith.vercel.app/search/searchxvideos?q=${q}`);
        ...
        const handleUserReply = async (update) => {
            ...
            for (let index of videoIndexes) {
                ...
                try {
                    let downloadRes = await fetchJson(`https://apis-keith.vercel.app/download/porn?url=${selectedVideo.url}`);
